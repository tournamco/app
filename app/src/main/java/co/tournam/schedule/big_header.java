 ...
 */
public class big_header extends View {
    ...
    public big_header(Context context) {
        super(context);
        init(null, 0);
    }

    public big_header(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public big_header(Context context, AttributeSet attrs, int defStyle) {
